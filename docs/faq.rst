...
==================================
Frequently asked questions for nextwave and Lavalink.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Connecting to Lavalink Nodes is simple in nextwave. For example:
...
See `Examples and Recipes` or `GitHub Examples <https://github.com/abindent/nextwave/tree/master/examples>`_ for more info.


How do I search YouTube for a track in 1.0?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Searching nextwave for Tracks is simpler in 1.0.
...
.. code:: python3
    ...
    partial = nextwave.PartialTrack(query="Ocean Drive", cls=nextwave.YouTubeTrack)
